...
namespace GrafRed
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            pictureBox.Size = new System.Drawing.Size(600, 500);
            ...
            switch (comboBox1.SelectedValue) ////
            {
                ...
                case (FigureType.Triangle):
                    graphSystem.CurrFigure = new Triangle(graphSystem.frame, pl);
                    break;
            }
        ...
        private void ComboBox1_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            switch ((FigureType)comboBox1.SelectedValue)
            {
                case (FigureType.Rect):
                    ...
                    break;
                case (FigureType.Triangle):
                    graphSystem.CurrFigure = new Triangle(graphSystem.frame, graphSystem.pl);
                    break;
                case (FigureType.Line):
            ...
            */
            ...
            switch (f.type)
            {
                ...
                case (FigureType.Triangle):
                    ...
                    gr.FillPolygon(new SolidBrush(fp.Color), curvePoints);
